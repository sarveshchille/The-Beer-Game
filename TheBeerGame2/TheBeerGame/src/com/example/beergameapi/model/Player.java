 ...
 *
 * This version is used by the GameEngine, which is part of a GameRoom.
 */
public class Player {
     ...
     * This logic is confirmed to be correct.
     */
    ...
    /**
     * Adds an order to this player's incoming order queue.
     * @param orderAmount The order to add
     */
    ...
    /**
     * Adds a shipment to this player's incoming shipment queue.
     * @param shipmentAmount The shipment to add
     */
     ...
     * This is called by the GameEngine *after* all steps are complete.
    ...
    // These allow the BeerGameServer to get the *current* state
    // to display to the user.
    public String getRole() { return role; }
    public int getInventory() { return inventory; }
    public int getBackorder() { return backorder; }
    public double getCumulativeCost() { return cumulativeCost; }
    public int getLastShipmentReceived() { return lastShipmentReceived; } // Used for "incomingDelivery"
    public int getLastOrderReceived() { return lastOrderReceived; }    // Used for "customerOrders"
    public int getLastShipmentSent() { return lastShipmentSent; }     // Used for "outgoingDelivery"
    public double getLastWeeklyCost() { return lastWeeklyCost; }       // Used for "costs"
    public int getLastOrderPlaced() { return lastOrderPlaced; }

    /** Returns the complete history list for the API. */
